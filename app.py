...
def _gen_personalized_text(user, cat_sc, sys_scores, date_label, mode, extra_context="", social_theme_text="", day_kyusei_name="", month_kyusei_name=""):
    ...
    if mode == "monthly":
        ...
        _lucky_exp_rule = "・lucky_explanation: 40〜55文字。「{{日盤九星名}}の{{属性}}が強い今日、{{最低カテゴリ}}運を底上げするには{{ラッキーアイテム/行動}}が効く。」の形式で1文で締める。「共鳴」「交差」などの描写ワード禁止。"
        _lucky_exp_schema = "ラッキーアイテム全体の占術的根拠（40〜55文字）"
...
{{
  ...
  "energy_message": "あなたにとって今日は〜な日。〜すると流れが変わる。（30文字以内）",
  "scores": {{"overall": 5, "money": 5, "love": 5, "work": 5, "health": 5, "social": 5}},
  "details": {{
    "overall": {{"score": 5, "message": "あなたは〜（共感フレーズ）。〜してみて（行動指示）。40文字以内"}},
    ...
    if uid:
        try:
            ...
            if not already:
                try:
                    _msg = (
                        "\U0001f319 \u661f\u591c\u5802\u3078\u3088\u3046\u3053\u305d \u2728\n\u661f\u591c\u5802\u306f\u3001\u8907\u6570\u306e\u5360\u8853\u3092\u7d44\u307f\u5408\u308f\u305b\u305f\n\u672c\u683c\u7684\u306a\u5360\u3044\u30b5\u30fc\u30d3\u30b9\u3067\u3059\u3002\n\n\u3010\u3067\u304d\u308b\u3053\u3068\u3011\n\U0001f4c5 \u4eca\u65e5\u306e\u904b\u52e2\n\u5168\u4f53\u904b\u30fb\u91d1\u904b\u30fb\u604b\u611b\u904b\u30fb\u4ed5\u4e8b\u904b\u30fb\n\u5065\u5eb7\u904b\u30fb\u5bfe\u4eba\u904b\u306e6\u30ab\u30c6\u30b4\u30ea\u3092\n\u30b9\u30b3\u30a2\u4ed8\u304d\u4e00\u89a7\u8868\u793a\n\n\U0001f4c6 \u4eca\u6708\u306e\u904b\u52e2\n\u30ab\u30c6\u30b4\u30ea\u5225\u30b9\u30b3\u30a2\uff0b\u4e0a\u6607/\u5b89\u5b9a/\u4e0b\u964d\u306e\n\u30c8\u30ec\u30f3\u30c9\u3068\u5409\u65e5\u30fb\u6ce8\u610f\u65e5\u3092\u304a\u77e5\u3089\u305b\n\n\U0001f52e \u5360\u8853\u5225\u8a3a\u65ad\n\u56db\u67f1\u63a8\u547d\u30fb\u7b97\u547d\u5b66\u30fb\u897f\u6d0b\u5360\u661f\u8853\u30fb\n\u6570\u79d8\u8853\u30fb\u7d2b\u5fae\u6597\u6570\u306e5\u5360\u8853\u306e\u7d50\u679c\u3092\n\u30b9\u30b3\u30a2\u4ed8\u304d\u3067\u4e00\u89a7\u3067\u304d\u307e\u3059\n\n\U0001f4ca \u4eca\u5e74/12\u5e74\u63a8\u79fb\u30b0\u30e9\u30d5\n5\u5360\u8853\u306e\u5168\u4f53\u904b\u3092\u6298\u308c\u7dda\u30b0\u30e9\u30d5\u753b\u50cf\u3067\n\u30c1\u30e3\u30c3\u30c8\u306b\u76f4\u63a5\u9001\u4fe1\u3057\u307e\u3059\n\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\n\U0001f4dd \u307e\u305a\u3001\u3042\u306a\u305f\u306e\u3053\u3068\u3092\u6559\u3048\u3066\u304f\u3060\u3055\u3044\uff01\n\u4ee5\u4e0b\u306e\u30ea\u30f3\u30af\u304b\u3089\u7c21\u5358\u306a\u8a3a\u65ad\uff08\u7d045\u301c7\u5206\uff09\u3092\u53d7\u3051\u308b\u3068\u3001\u3042\u306a\u305f\u3060\u3051\u306b\u30ab\u30b9\u30bf\u30de\u30a4\u30ba\u3055\u308c\u305f\u5360\u3044\u304c\u5c4a\u304f\u3088\u3046\u306b\u306a\u308a\u307e\u3059\u2728\n\n\U0001f52e \u8a3a\u65ad\u306f\u3053\u3061\u3089\n"
