...
ã»æ­è¨ãããå¾åã»æµãã¨ãã¦è¡¨ç¾ããï¼ãããªæµããããããããæããä¸æ¥ï¼ã²ã¨æï¼ããããåãããããããã«æè­ãåããããããªã©ã®è¡¨ç¾ãä½¿ã
ã»èª­ãã äººããããããã¦ãããããã¨ããï¼ãã¨æãããããªãæå ãçãªæ½è±¡åº¦ã§æ¸ã
ã»å·ä½çãªæéå¸¯ã»å ´æã»ç¹å®ã®äººç©ã¯æ¸ããªã
ã»ã¦ã¼ã¶ã¼ã®ç¶æ³ï¼åªåäºé ã»ææç¶æ³ã»ææ¦ä¸­ã®ãã¨ï¼ã®é°å²æ°ããããããç¹ãè¾¼ã
ã»{guidance}
ã»overall_messageã¯è©©çãã¤æ¬è³ªãã¤ããä¸æãèª­ãã äººã®å¿ã«éãã«é¿ãè¨èã§
ã»ã¹ã³ã¢ã¯1ã10ã®å¨ç¯å²ãæ­£ç´ã«åæ ãããçµ±è¨çã«å¹³å5ã6ã«ãªããããä½éï¼1ã4ï¼ã»ä¸­éï¼5ã6ï¼ã»å¥½éï¼7ã10ï¼ããã©ã³ã¹ããä½¿ã
ã»å¨ã«ãã´ãªãé«ãæ¥ãä½ãæ¥ããããã¦ã¼ã¶ã¼ã®çã¾ãæå ±ã¨ä»æ¥ã®å¹²æ¯ã»æåãã»æ°ã®æµããæ­£ç´ã«åæ ããç¹å®ã¹ã³ã¢å¸¯ã«åããªã
ã»ã¹ã³ã¢8ä»¥ä¸ï¼å¯è½æ§ãå¥½æ©ã®ãæµãããæããããååããªè¡¨ç¾
ã»ã¹ã³ã¢4ä»¥ä¸ï¼ç¡çãããªããã¨ãåçã®ãæµãããæãããããç©ãããªæ³¨æã®è¡¨ç¾
ã»ã¹ã³ã¢5ã7ï¼éããªã¨ãã«ã®ã¼ã®ä¸­ã«ããæ°ã¥ããå¤åã®åããä¼ãã
ã»åã«ãã´ãªã®messageã¯ãå è¡çèæ¯ãæããããè¡¨ç¾ãï¼ãæã®éç½®ãç¤ºãããæ°ã®ã¨ãã«ã®ã¼ãããå¤©å¹²å°æ¯ã®æµãã§ããä¹æã®æ°ã®æµããããªã©ï¼ãèªç¶ã«ç¨ããååã«ç¾å¨ã®ç¶æã»ã¨ãã«ã®ã¼ãå¾åã«æè­ãã¹ãå·ä½çãã¼ããå«ãã

ä»¥ä¸ã®JSONå½¢å¼ã®ã¿ã§è¿ãã¦ãã ããï¼
{{
  "overall_message": "{period}ãè©©çã«è¡¨ç¾ããä¸æï¼50æå­ä»¥åã»å¾åã»æ¬è³ªéè¦ï¼",
  "categories": {{
    "å¨ä½é": {{"message": "å è¡çæ ¹æ ãæãããããç¾å¨ã®ç¶æã»ã¨ãã«ã®ã¼ãï¼ãæè­ãã¹ãå·ä½çãã¼ããï¼50ã80æå­ï¼", "reason": "ãªããããªããã»å è¡çæ ¹æ ï¼25æå­ä»¥åï¼"}},
    "éé": {{"message": "å è¡çæ ¹æ ãæãããããç¾å¨ã®ç¶æã»ã¨ãã«ã®ã¼ãï¼ãæè­ãã¹ãå·ä½çãã¼ããï¼50ã80æå­ï¼", "reason": "ãªããããªããã»å è¡çæ ¹æ ï¼25æå­ä»¥åï¼"}},
    "ææé": {{"message": "å è¡çæ ¹æ ãæãããããç¾å¨ã®ç¶æã»ã¨ãã«ã®ã¼ãï¼ãæè­ãã¹ãå·ä½çãã¼ããï¼50ã80æå­ï¼", "reason": "ãªããããªããã»å è¡çæ ¹æ ï¼25æå­ä»¥åï¼"}},
    "ä»äºé": {{"message": "å è¡çæ ¹æ ãæãããããç¾å¨ã®ç¶æã»ã¨ãã«ã®ã¼ãï¼ãæè­ãã¹ãå·ä½çãã¼ããï¼50ã80æå­ï¼", "reason": "ãªããããªããã»å è¡çæ ¹æ ï¼25æå­ä»¥åï¼"}},
    "å¥åº·é": {{"message": "å è¡çæ ¹æ ãæãããããç¾å¨ã®ç¶æã»ã¨ãã«ã®ã¼ãï¼ãæè­ãã¹ãå·ä½çãã¼ããï¼50ã80æå­ï¼", "reason": "ãªããããªããã»å è¡çæ ¹æ ï¼25æå­ä»¥åï¼"}},
    "å¯¾äººé": {{"message": "å è¡çæ ¹æ ãæãããããç¾å¨ã®ç¶æã»ã¨ãã«ã®ã¼ãï¼ãæè­ãã¹ãå·ä½çãã¼ããï¼50ã80æå­ï¼", "reason": "ãªããããªããã»å è¡çæ ¹æ ï¼25æå­ä»¥åï¼"}}
  }},
...
def fmt_daily(data):
    ...
    for cat, emoji in CAT_EMOJI.items():
        ...
        score = d.get("score", 5)
        lines.append(f"{emoji} {cat}  â {score}/10 â")
...
def past_graph_image_thread(user_id, user):
    try:
        ...
        push_image(user_id, img_url)
        push(user_id,
             "ð éå»12å¹´ã®éå¢æ¨ç§»ã§ãã\n\nå®éã«è¯ãã£ãå¹´ã»å¤§å¤ã ã£ãå¹´ã¨ãã©ã®å è¡ã®å¥½èª¿ã»ä½èª¿ã®æ³¢ãä¸è´ãã¦ãããç¢ºèªãã¦ã¿ã¦ãã ããã\nä¸çªä¸è´ãã¦ããå è¡ãããªãã¨ã®ç¸æ§ãé«ãå è¡ã§ãâ¨")
        legend = (
            "ð ã°ã©ãã®è²ã®å¡ä¾\n"
            + LEGEND_TEXT + "\n\n"
            "ð¸ ã¹ã¯ãªã¼ã³ã·ã§ããã§ä¿å­ã§ãã¾ãã\n"
